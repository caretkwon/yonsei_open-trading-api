...
저는 이번 여름방학에 종강 이후로도 계속 학교 연구실에 나와있을 예정으로 연구실 일정을 제외하면, 오전 8시와 오후 8시 사이 언제든 인터뷰할 시간이 있습니다.

월요일 오후 2시에서 4시, 금요일 오전 10시에서 12시를 제외한 모든 시간은 비울 수 있습니다.

제가 제출하는 과제의 알고리즘은 매일 1시간 간격으로 삼성전자를 하나씩 산 후, 금요일 종가에 팔아버리는 방법입니다.
유명한 격언인 월요일에 사고 금요일에 팔아라에서 얻어온 아이디어입니다.
